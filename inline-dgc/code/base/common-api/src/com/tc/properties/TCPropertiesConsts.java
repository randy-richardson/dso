...
public interface TCPropertiesConsts {
   ...
   * dgc.startActive.delayInMillis  - Delay time before triggering a DGC when entering active mode. (only used when periodic dgc is disabled)
  ...
  public static final String L2_OBJECTMANAGER_DGC_START_ACTIVE_DELAY                         = "l2.objectmanager.dgc.startActive.delayInMillis";
