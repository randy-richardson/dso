...
public abstract class TickerTokenManager {
  ...
  private final Map<TickerTokenKey, TCTimer>           timerMap          = Collections
                                                                             .synchronizedMap(new HashMap<TickerTokenKey, TCTimer>());
  ...
  private TCTimer removeTimer(TickerToken token) {
