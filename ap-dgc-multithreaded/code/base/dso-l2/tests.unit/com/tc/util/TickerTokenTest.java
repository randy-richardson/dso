...
public class TickerTokenTest extends TestCase {
  ...
  public void testToken() {
    ...
    int tickValue = 0;
    TestTickerToken token = new TestTickerToken(primaryId, tickValue);
  ...
  public void testTokenWithFactory() {
    ...
    TestTickerToken messageToken = message.getTickerToken();
    
    assertEquals(0, messageToken.getPrimaryID());
    assertEquals(1, messageToken.getPrimaryTickValue());
    
    TestTickerToken triggerToken2 = factory.createTriggerToken(1, 2);
