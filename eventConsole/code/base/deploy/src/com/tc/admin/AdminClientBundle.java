...
public class AdminClientBundle extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
        ...
        { "cluster.events.timeOfEvent", "Time of Event" },
        { "cluster.events.node", "Node" },
        { "cluster.events.eventType", "Event Type" },
        { "cluster.events.system" , "Event System"},
        { "cluster.events.message" , "Message" },
        { "map.entry", "MapEntry" },
        { "log.error", "ERROR" },
        { "log.warn", "WARN" },
        { "log.info", "INFO" },
