...
public class L2MBeanNames {
  ...
  public static final ObjectName L2_SUSBSYSTEM_EVENTS_PUBLIC;
  ...
  static {
    try {
      ...
      SERVER_DB_BACKUP = TerracottaManagement.createObjectName(Type.Server, Subsystem.None, null,
                                                               ...
                                                               TerracottaManagement.MBeanDomain.INTERNAL);
      L2_SUSBSYSTEM_EVENTS_PUBLIC = TerracottaManagement.createObjectName(Type.TcCriticalEvents, Subsystem.None, null,
