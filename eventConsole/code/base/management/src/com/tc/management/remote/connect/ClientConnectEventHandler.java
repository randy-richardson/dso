...
public class ClientConnectEventHandler extends AbstractEventHandler {
    ...
    synchronized (channelIdToJmxConnector) {
      if (!channelIdToJmxConnector.containsKey(channel.getChannelID())) {
        ...
        try {
          ...
          // try {
          // l2MBeanServer.addNotificationListener(MBeanNames.OPERATOR_EVENTS_PUBLIC, new L1OperatorEventsLogger(),
  ...
  private static class ClientBeanBag {
        ...
        if (TerracottaManagement.matchAllTerracottaMBeans(id).apply(objName)) {
          if (beanNames.add(modifiedObjName)) {
            try {
              ...
              l2MBeanServer.addNotificationListener(modifiedObjName, new L1OperatorEventsLogger(),
                                                    new OperatorEventsFilter(), null);
            } catch (Throwable t) {
    ...
    // TODO: change it after nihit's server and client builder changes
    static class L1OperatorEventsLogger implements NotificationListener {
