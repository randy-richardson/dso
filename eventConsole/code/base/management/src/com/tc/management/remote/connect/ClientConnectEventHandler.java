...
public class ClientConnectEventHandler extends AbstractEventHandler {
  ...
  private final NotificationListener tcSubSystemEventListener;
  ...
  public ClientConnectEventHandler(final StatisticsGateway statisticsGateway,
                                   NotificationListener tcSubSystemEventListener) {
    this.statisticsGateway = statisticsGateway;
    this.tcSubSystemEventListener = tcSubSystemEventListener;
  }
    ...
    synchronized (channelIdToJmxConnector) {
      if (!channelIdToJmxConnector.containsKey(channel.getChannelID())) {
        ...
        try {
          ...
          ClientBeanBag bag = new ClientBeanBag(l2MBeanServer, this.tcSubSystemEventListener, channel, uuid,
  ...
  private static class ClientBeanBag {
    ...
    public ClientBeanBag(MBeanServer l2MBeanServer, NotificationListener tcSubSystemEventListener,
