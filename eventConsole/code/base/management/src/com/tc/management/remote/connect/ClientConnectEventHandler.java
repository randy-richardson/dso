      ...
      if (!channelIdToJmxConnector.containsKey(channel.getChannelID())) {
        ...
        try {
          ...
          try {
            ...
            l1MBeanServerConnection
                .addNotificationListener(on, new MBeanRegistrationListener(bag), new RemoteRegistrationFilter(uuid, msg
                    .getTunneledDomains()), null);
          } catch (Exception e) {
          ...
          Set mBeans = l1MBeanServerConnection.queryNames(null, TerracottaManagement.matchAllTerracottaMBeans(uuid, msg
              .getTunneledDomains()));
