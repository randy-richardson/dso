...
public class ClientConnectEventHandler extends AbstractEventHandler {
  ...
  private final L1OperatorEventsLogger l1OperatorEventsLogger;
  ...
  public ClientConnectEventHandler(final StatisticsGateway statisticsGateway,
                                   L1OperatorEventsLogger operatorEventsLogger) {
  ...
  private static class ClientBeanBag {
    ...
    public ClientBeanBag(MBeanServer l2MBeanServer, MessageChannel channel, UUID id,
                         MBeanServerConnection l1Connection, L1OperatorEventsLogger operatorEventsLogger) {
